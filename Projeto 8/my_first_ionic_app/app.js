...
confirmBtn.addEventListener('click', () => {
    ...
    if (enteredReason.trim().length <= 0 || enteredAmount <= 0 || enteredAmount.trim().length <= 0) {
        //CRIANDO UM ALERTA PERSONALIZADO COM IONIC
        const alertIon = document.createElement('ion-alert');
        alertIon.header = 'Dados inválidos';
        alertIon.message = 'Por favor, coloque um nome e um valor válidos!';
        alertIon.buttons = ['Entendi'];
